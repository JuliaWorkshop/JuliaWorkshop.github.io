...
Extreme Value Theory (EVT) is primarily concerned with modeling the tails of probability distributions, focusing on extreme events. 

Here are the main probability distributions used in EVT:
